...
function registrasi($data) {
	...
	$nama_wisata = stripcslashes($data["nama_wisata"]);
	$alamat = stripcslashes($data["alamat"]);
	$rating = htmlspecialchars($data["rating"]);;
	$jml_lokal = htmlspecialchars($data["jml_lokal"]);
	$jml_manca = htmlspecialchars($data["jml_manca"]);
	...
	mysqli_query($conn, "INSERT INTO tb_wisata VALUES ('', '$gambar', '$nama_wisata', '$alamat', '$rating', '$jml_lokal', '$jml_manca')");
...
if (isset($_POST["tambah"])) {
	if (registrasi($_POST) > 0) {
		...
		echo "<script>
			alert('Data wisata gagal ditambahkan!');
		</script>";
	}
}
...
<body>
	...
	<form action="" method="POST" enctype="multipart/form-data">
		...
		<p> Lamongan Paradise </p>
				...
				<input type="text" name="nama_wisata" id="nama_wisata" placeholder="Nama Wisata">
				...
				<label for="jml_lokal"> Jumlah Pengunjung Lokal </label>
				<input type="text" name="jml_lokal" id="jml_lokal" placeholder="Jumlah Pengunjung Lokal">

				<label for="jml_manca"> Jumlah Pengunjung Mancanegara </label>
				<input type="text" name="jml_manca" id="jml_manca" placeholder="Jumlah Pengunjung Mancanegara">
