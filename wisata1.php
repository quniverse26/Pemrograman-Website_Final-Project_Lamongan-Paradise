...
<body>
	<nav>
		...
		<ul>
			...
			<li class="active"><a href="wisata1.php"> Wisata</a>
	...
	<div class="small-container">
		<!-- menampilkan data wisata yang diambil dari database -->
		<?php
		$produk = mysqli_query($conn, "SELECT * FROM tb_wisata");
		while($hasil = mysqli_fetch_array($produk)){
			?>
			<div class="box-produk">
				<img src="image/<?php echo $hasil['gambar']; ?>" />
				<?php echo $hasil['nama_wisata']."<br><br>"; ?>
				<?php echo $hasil['alamat']."<br>"; ?>
				<?php echo "Rating: ". " ".$hasil['rating']."<br>"; ?>
			</div>
		<?php
		 } ?>
