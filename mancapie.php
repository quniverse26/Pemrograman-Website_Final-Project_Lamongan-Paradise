...
<head>
	<title> Pie Chart - Jumlah Wisatawan Mancanegara </title>
	<script type="text/javascript" src="Chart.js"></script>
</head>

<body>
	<center><h3> Jumlah Wisatawan Manca pada Tahun 2022 </h3></center>
<center>
	<center>
		...
		var config = {
			...
			data: {
				datasets: [{
					...
					label: 'Jumlah Wisatawan Mancanegara pada Tahun 2022'
				}],
