...
<body>
	...
	<nav>
		...
		<ul>
			...
			<li><a href="oleh2.php"> Oleh-Oleh </a></li>
...
<h2>DATA WISATA</h2>
	...
	include 'koneksi.php';
	$id = $_GET['id'];
	$data = mysqli_query($conn,"SELECT * FROM tb_wisata WHERE id='$id'");
	while($d = mysqli_fetch_array($data)){
		...
		<form method="post" action="update.php">
			<table>
				...
				<tr>
					<td>Nama Wisata</td>
					<td><input type="text" name="nama_wisata" value="<?php echo $d['nama_wisata']; ?>"></td>
				</tr>
				<tr>
					<td>Alamat</td>
				...
				<tr>
					<td>Jumlah Pengunjung Lokal</td>
					<td><input type="text" name="jml_lokal" value="<?php echo $d['jml_lokal']; ?>"></td>
				</tr>
				<tr>
					<td>Jumlah Pengunjung Mancanegara</td>
					<td><input type="text" name="jml_manca" value="<?php echo $d['jml_manca']; ?>"></td>
				</tr>
				<tr>
					<td></td>
